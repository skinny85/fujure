...
fileContents returns [ org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.FileContents result ] : Surrogate_id_SYMB_20 p_1_2=pkgName p_1_3=imports p_1_4=defs  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.FileInNamedPackage($p_1_2.result,$p_1_3.result,$p_1_4.result); } # FileInNamedPackage 
...
;
import_ returns [ org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.Import result ] : Surrogate_id_SYMB_19 p_1_2=listImportFragm  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.ImportStmt($p_1_2.result); } # ImportStmt 
;
...
;
def returns [ org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.Def result ] : Surrogate_id_SYMB_17 p_1_2=binding  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.SimpleValueDef($p_1_2.result); } # SimpleValueDef 
;
...
;
expr2 returns [ org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.Expr result ] : p_1_1=expr2 Surrogate_id_SYMB_5 p_1_3=expr3  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.LesserExpr($p_1_1.result,$p_1_3.result); } # LesserExpr 
  | p_2_1=expr2 Surrogate_id_SYMB_6 p_2_3=expr3  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.LesserEqualExpr($p_2_1.result,$p_2_3.result); } # LesserEqualExpr
  | p_3_1=expr2 Surrogate_id_SYMB_7 p_3_3=expr3  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.GreaterExpr($p_3_1.result,$p_3_3.result); } # GreaterExpr
  | p_4_1=expr2 Surrogate_id_SYMB_8 p_4_3=expr3  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.GreaterEqualExpr($p_4_1.result,$p_4_3.result); } # GreaterEqualExpr
  | p_5_1=expr3  { $result = $p_5_1.result; } # Coercion_Expr2
;
expr3 returns [ org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.Expr result ] : p_1_1=expr3 Surrogate_id_SYMB_9 p_1_3=expr4  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.AdditionExpr($p_1_1.result,$p_1_3.result); } # AdditionExpr 
  | p_2_1=expr3 Surrogate_id_SYMB_10 p_2_3=expr4  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.SubtractionExpr($p_2_1.result,$p_2_3.result); } # SubtractionExpr
  | p_3_1=expr4  { $result = $p_3_1.result; } # Coercion_Expr3
;
expr4 returns [ org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.Expr result ] : p_1_1=expr4 Surrogate_id_SYMB_11 p_1_3=expr5  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.MultiplicationExpr($p_1_1.result,$p_1_3.result); } # MultiplicationExpr 
  | p_2_1=expr4 Surrogate_id_SYMB_12 p_2_3=expr5  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.DivisionExpr($p_2_1.result,$p_2_3.result); } # DivisionExpr
  | p_3_1=expr4 Surrogate_id_SYMB_13 p_3_3=expr5  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.ModuloExpr($p_3_1.result,$p_3_3.result); } # ModuloExpr
  | p_4_1=expr5  { $result = $p_4_1.result; } # Coercion_Expr4
;
expr5 returns [ org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.Expr result ] : Surrogate_id_SYMB_14 p_1_2=expr5  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.NotExpr($p_1_2.result); } # NotExpr 
  ...
  | Surrogate_id_SYMB_15 p_4_2=expr Surrogate_id_SYMB_16  { $result = $p_4_2.result; } # Coercion_Expr5
;
...
literal returns [ org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.Literal result ] : p_1_1=INTEGER  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.IntLiteral(Integer.parseInt($p_1_1.getText())); } # IntLiteral 
  | Surrogate_id_SYMB_22  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.UnitLiteral(); } # UnitLiteral
  | Surrogate_id_SYMB_21  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.BoolTrueLiteral(); } # BoolTrueLiteral
  | Surrogate_id_SYMB_18  { $result = new org.fujure.fbc.parser.bnfc.antlr.Fujure.Absyn.BoolFalseLiteral(); } # BoolFalseLiteral

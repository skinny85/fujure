...
import org.fujure.fbc.parser.bnfc.antlr.fujure.*;
import java.io.*;
...
public class Test
{
  ...
  public org.fujure.fbc.parser.bnfc.antlr.fujure.Absyn.FileContents parse() throws Exception
  {
    /* The default parser is the first-defined entry point. */
    fujureParser.Start_FileContentsContext pc = p.start_FileContents();
    org.fujure.fbc.parser.bnfc.antlr.fujure.Absyn.FileContents ast = pc.result;
    System.out.println();

...
sealed class ProblematicFile(open val userProvidedFilePath: String) {
    sealed class BasicFileIssue(userProvidedFilePath: String) : ProblematicFile(userProvidedFilePath) {
        data class InvalidFileExtension(override val userProvidedFilePath: String) : BasicFileIssue(userProvidedFilePath)
        data class FileNotFound(override val userProvidedFilePath: String) : BasicFileIssue(userProvidedFilePath)
        data class CouldNotOpenFile(override val userProvidedFilePath: String, val error: Throwable) : BasicFileIssue(userProvidedFilePath)
    }
